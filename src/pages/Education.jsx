...
export const Education = () => {
  return (
    <section className=" bg-[#0a1019]">
      <div className="w-10/12 max-w-maxContent mx-auto pt-16 md:pt-32 pb-40">
        <div>
          <h3 className="text-2xl md:text-4xl  leading-4 text-[#55e6a5] font-sans  font-semibold uppercase mb-7 md:mb-10">
            Education
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 mt-4 md:mt-0 space-y-4 md:space-y-0 md:space-x-14  ">
